...
$('#form-bookmarklet').submit(function() {
    ...
    var bookmarkletFunctionString = 'var ficsaveStoryUrl=encodeURI(window.location.href);var ficsaveFormat="'+format+'";var ficsaveEmail="'+Base64.encode(email)+'";var ficsaveUrl="http://ficsave.com/?url="+ficsaveStoryUrl+"&format="+ficsaveFormat+"&em="+ficsaveEmail+"&download=yes";window.open(ficsaveUrl, "_blank");';
